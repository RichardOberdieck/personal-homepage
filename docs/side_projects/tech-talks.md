...
Probably our most watched tech talk. The aim was to demystify the concept of a "strong" MIP formulation versus a "weak" one. First, we formulated some general principles as to why this phenomenon exists, before looking at a couple of simple examples.
...
There are a couple of Tech Talks which are not on YouTube unfortunately, so I cannot list them here. 
